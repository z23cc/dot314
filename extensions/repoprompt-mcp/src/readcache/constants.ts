// readcache/constants.ts - constants for read_file caching layer

export const RP_READCACHE_META_VERSION = 1 as const;
export const RP_READCACHE_CUSTOM_TYPE = "repoprompt-mcp-readcache" as const;
...
// NOTE: we intentionally share the same on-disk object store layout as pi-readcache
// (content-addressed sha256 snapshots). This avoids duplicating storage when both are installed
